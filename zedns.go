...
func (rr *NSID) Name(x ...dnswire.Name) (dnswire.Name, error) {
	return (&Hdr{rr.octets, nil}).Name(x...)
}

func (rr *NSID) Type(x ...dnswire.Type) (dnswire.Type, error) {
...
func (rr *PADDING) TTL(x ...dnswire.TTL) (dnswire.TTL, error) {
	return (&Hdr{rr.octets, nil}).TTL(x...)
}
